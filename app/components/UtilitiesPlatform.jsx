...
import aoeMarket from "../assets/images/aoemarket.jpg";
  ...
  return (
    <Container maxW={"7xl"}>
      ...
      <Fade left delay={300} duration={1700}>
        <div className="grid token-img  grid-cols-4 max-md:grid-cols-4 max-sm:grid-cols-2 gap-4">
          <ExploreCard
            icon={iProspa}
          ...
          <ExploreCard icon={aoeMarket} text="shop and earn upto 90% in cashback - Coming Soon" />
          <ExploreCard icon={aoeMarket} text="Shop at discount with $TAJI" />
        </div>
      </Fade>
      </section>
    </Container>
