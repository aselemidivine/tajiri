      ...
      <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class=" p-tag text-body-color font-light mb-7 text-base">
                Tajiri is a Global Decentralized Economy Ecosystem for Africa –
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="text-dark mb-9 text-lg font-semibold">Documentation</h4>
              <ul>
                <li>
                  <a
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="text-dark mb-9 text-lg font-semibold">Community & Forum</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="text-dark mb-9 text-lg font-semibold">Important Links</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
...
Tajiri Bounty (QTAJ)
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class=" p-tag text-body-color text-base">
                &copy; 2023 Gotajiri. All Rights Reserved
              </p>
            </div>
          </div>
        </div>
